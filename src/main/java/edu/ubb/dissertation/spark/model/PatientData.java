...
import static edu.ubb.dissertation.spark.util.Constants.*;
...
public class PatientData {
    ...
    private List<String> abnormalVitalSigns;
    ...
    private PatientData(final Builder builder) {
        ...
        this.abnormalVitalSigns = builder.abnormalVitalSigns;
    ...
    public void configureErrorTypes() {
        systolicBloodPressureType = extractVitalSignType(SYSTOLIC_BLOOD_PRESSURE_ABOVE_UPPER_LIMIT, SYSTOLIC_BLOOD_PRESSURE_BELOW_LOWER_LIMIT);
        diastolicBloodPressureType = extractVitalSignType(DIASTOLIC_BLOOD_PRESSURE_ABOVE_UPPER_LIMIT, DIASTOLIC_BLOOD_PRESSURE_BELOW_LOWER_LIMIT);
        heartRateType = extractVitalSignType(HEART_RATE_ABOVE_UPPER_LIMIT, HEART_RATE_BELOW_LOWER_LIMIT);
        oxygenSaturationLevelType = extractVitalSignType(OXYGEN_SATURATION_LEVEL_ABOVE_UPPER_LIMIT, OXYGEN_SATURATION_LEVEL_BELOW_LOWER_LIMIT);
    }

    private Integer extractVitalSignType(final String upperLimitKey, final String lowerLimitKey) {
    ...
    public static class Builder {
        ...
        public Builder withAbnormalVitalSigns(final List<String> abnormalVitalSigns) {
    ...
    public List<String> getAbnormalVitalSigns() {
